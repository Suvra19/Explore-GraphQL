...
<html>
<head>
  <title>schema_schema.litcoffee</title>
    ...
    <ul class="sections">
        ...
        <li id="section-1">
            <div class="annotation">
              ...
              <p>Model schema for Schema objects</p>

            </div>
            
            <div class="content"><div class='highlight'><pre><span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">SchemaSchema</span></span>

  <span class="hljs-property">@schema</span> = { <span class="hljs-attribute">name</span>: <span class="hljs-string">'Schema'</span>, <span class="hljs-attribute">definition</span>: {
    ...
    <span class="hljs-attribute">definition</span>: {}
  }}
...
<span class="hljs-built_in">module</span>.<span class="hljs-built_in">exports</span> = SchemaSchema</pre></div></div>
