...
<html>
<head>
  <title>static_router.litcoffee</title>
    ...
    <ul class="sections">
        ...
        <li id="section-1">
            <div class="annotation">
              ...
              <p>StaticRouter is Graph API Router returning always the data specified in node’s configuration</p>

            </div>
            
            <div class="content"><div class='highlight'><pre><span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">StaticRouter</span></span>

  <span class="hljs-property">@route</span>: <span class="hljs-function"><span class="hljs-params">(query, callback)</span> -&gt;</span>
    query.graph.debug(<span class="hljs-string">'StaticRouter&gt;'</span>, { <span class="hljs-attribute">data</span>: query.current_router.configuration })
    query.data = query.current_router.configuration
    callback(query)

<span class="hljs-built_in">module</span>.<span class="hljs-built_in">exports</span> = StaticRouter</pre></div></div>
