  ...
  <div id="container">
    ...
    <ul class="sections">
        ...
        <li id="section-1">
            ...
            <div class="content"><div class='highlight'><pre><span class="hljs-built_in">exports</span>.Graph = <span class="hljs-built_in">require</span>(<span class="hljs-string">'./graph'</span>)
<span class="hljs-built_in">exports</span>.ConfigurationManager = <span class="hljs-built_in">require</span>(<span class="hljs-string">'./configuration_manager'</span>)</pre></div></div>
