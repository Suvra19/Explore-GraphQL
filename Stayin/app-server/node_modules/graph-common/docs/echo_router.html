...
<html>
<head>
  <title>echo_router.litcoffee</title>
    ...
    <ul class="sections">
        ...
        <li id="section-1">
            <div class="annotation">
              ...
              <p>EchoRouter is Graph API Router returning data back unchanged</p>

            </div>
            
            <div class="content"><div class='highlight'><pre><span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">EchoRouter</span></span>

  <span class="hljs-property">@route</span>: <span class="hljs-function"><span class="hljs-params">(query, callback)</span> -&gt;</span>
    callback(query)

<span class="hljs-built_in">module</span>.<span class="hljs-built_in">exports</span> = EchoRouter</pre></div></div>
